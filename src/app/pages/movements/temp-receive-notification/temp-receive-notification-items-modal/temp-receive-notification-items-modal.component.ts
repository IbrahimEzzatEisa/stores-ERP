  ...
  @Component({
    selector: 'app-temp-receive-notification-items-modal',
    templateUrl: './temp-receive-notification-items-modal.component.html',
    styleUrls: ['./temp-receive-notification-items-modal.component.css']
  })
  export class TempReceiveNotificationItemsModalComponent implements OnInit {
    ...
    onSelectedItemGroupChange(itemGroup: ItemGroup) {
      this.orderItems.itemGroupId = itemGroup.itemGroupId+'';
