...
@Component({
  selector: 'app-transfer-custody-report',
  templateUrl: './transfer-custody-report.component.html',
  styleUrls: ['./transfer-custody-report.component.css']
})
export class TransferCustodyReportComponent implements OnInit {
