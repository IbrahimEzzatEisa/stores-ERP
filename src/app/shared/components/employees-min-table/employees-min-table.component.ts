  ...
  @Component({
    selector: 'app-employees-min-table',
    templateUrl: './employees-min-table.component.html',
    styleUrls: ['./employees-min-table.component.css']
  })
  export class EmployeesMinTableComponent implements OnInit {
